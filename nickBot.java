 ...
 * version 2.0
*/
public class nickBot extends AIWithComputationBudget {
    ...
    public nickBot(UnitTypeTable utt) {
        super(-1, -1);
        _utt = utt;
    ...
    int combatScore(Unit u, Unit e) {
        ...
        if (u.getType() == _utt.getUnitType("Ranged") 
            ...
            score += 3; //todo may be change that and add logic below
